        ...
        'paymentConfig' => [        // 支付方式配置
            'standard' => [            // 标准支付类型：在购物车页面进入下单页面，填写支付信息，然后跳转到第三方支付网站的支付类型。
                ...
                'paypal_standard' => [
                    ...
                    // 'websrc_url' => 'https://www.paypal.com/cgi-bin/webscr',
                    ...
                    // 'account' => 'andysunguisheng_api1.gmail.com',
                    // 'password' => 'RGX7HX35PCAZJKRE',
                    // 'signature' => 'ACJg2PUUSSBGx.dfOiULQHeqBhqlA1jfzuF0zctZZYOEmgClCbMhhbcF',
